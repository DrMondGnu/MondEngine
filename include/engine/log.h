...
namespace mondengine {
    ...
    public:
        ...
        MOND_API inline static std::shared_ptr<spdlog::logger> get_mond_engine_logger() {return mp_mond_engine_logger;}
        MOND_API inline static std::shared_ptr<spdlog::logger> get_app_logger () {return mp_app_logger;}
...
#define APP_TRACE(...) mondengine::Log::get_mond_engine_logger()->trace(__VA_ARGS__)
#define APP_DEBUG(...) mondengine::Log::get_mond_engine_logger()->debug(__VA_ARGS__)
#define APP_INFO(...) mondengine::Log::get_mond_engine_logger()->info(__VA_ARGS__)
#define APP_WARN(...) mondengine::Log::get_mond_engine_logger()->warn(__VA_ARGS__)
#define APP_ERROR(...) mondengine::Log::get_mond_engine_logger()->error(__VA_ARGS__)
